...
public class DECUitlImpl implements DECUtil {
    /**
     * DEC加密算法
     *
     * @Autor william
    ...
    public String encrypt(String unencryptedPwd) {
        ...
        String plaintext = unencryptedPwd;
        String type = "encrypt";
        DECUtil decUtil = new DECUitlImpl();
        String ciphertext = ((DECUitlImpl) decUtil).encrypt(plaintext, key, type);
    ...
    public String decipher(String encryptedPwd) {
        ...
        String ciphertext = encryptedPwd;
        String type = "decrypt";
        DECUtil decUtil = new DECUitlImpl();
        String plaintext = ((DECUitlImpl) decUtil).encrypt(ciphertext, key, type);
