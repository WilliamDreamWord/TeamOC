...
module.exports = (function staticCache(options) {
    ...
    return (function staticCache(req, res, next) {
        ...
        req.on("static", (function (stream) {
            ...
            var headers = res._headers, cc = utils.parseCacheControl(headers["cache-control"] || ""),
                contentLength = headers["content-length"], hit;
...
function mustRevalidate(req, cacheEntry) {
    ...
    var cacheHeaders = cacheEntry[1], reqCC = utils.parseCacheControl(req.headers["cache-control"] || ""),
